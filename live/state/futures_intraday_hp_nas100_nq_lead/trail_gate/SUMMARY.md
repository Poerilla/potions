# NAS100 first-hour follow 3R strong + sweep_with_side (broker-like)
...
Realism: slip 1 tick, spread model, fee $1.50/unit, NAS100 $1/pt.

| Book | Trades | WR | Net | Stress DD | N/S |
|---|---:|---:|---:|---:|---:|
| follow 3R strong + sweep_with_side | 56 | 50.0% | $-55 | $-1,118 | -0.05 |
| follow 3R strong + sweep_with_side + 1h ST trail | 56 | 50.0% | $-41 | $-1,100 | -0.04 |

## Trail vs fixed stop

- Improved (net or N/S): **yes**
- ΔN/S = +0.01, Δnet = $+14, ΔWR = +0.0 pp

## How price meets the ST trail

- Trail modifies: 68
- Approach bars (within 8 pts): 4 across 8 trades
- Bounce bars (close away ≥12 pts without hitting): 4; trades with a bounce: 6 (rate given approach **75%**)
- Aggressive bounces (close away ≥25 pts): 3 bars / 3 trades (**8%** of trail trades)
- Median bounce size: **33.2 pts**
