...
| Metric | Value |
|---|---:|
| Source | `live/state/weekly_mid_ma500_bias_broker_like_nq_ym_mnq/states/ym_weekly_mid_ma500_bias/fills.csv` |
| Bar source | `live/state/weekly_mid_ma500_bias_broker_like_nq_ym_mnq/states/ym_weekly_mid_ma500_bias/bars/YM_15m.csv` |
...
| Net points | -41.00 |
| Point value | $5.00 |
| Net dollars | $-2,036.50 |
| Close MTM DD | $-28,628.00 |
| Intrabar stress MTM DD | $-28,663.00 |
| Max open units | 1 |
