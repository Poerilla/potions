...
![Dow Managed Intraday Diversifier Strategy vs DIA](dow_managed_intraday_diversifier_vs_dia_20k.png)
...
| $20k-path CAGR | 18.1% |
| Sharpe / Sortino | 2.02 / 2.62 |
| Calmar / MAR on modeled stress | 1.01 |
| Calmar on worst annual closed DD | 1.97 |
| Max drawdown duration | 302 days |
| Daily skew | 1.35 |
| QQQ corr / downside capture | -0.00 / -0.33 |
| DIA corr / downside capture | 0.00 / -0.15 |
| Profit factor / win rate | 1.71 / 59.8% |
| Modeled intrabar stress / closed DD | $-2,665 / $-2,627 |
