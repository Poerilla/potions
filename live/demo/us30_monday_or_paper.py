"""US30 Monday OR Phase 2 primary — paper demo (OANDA prices, PaperBroker fills).

Tracker / Phase 2 default: ``M3_S3_R2`` (``monday_or_breakout``), N/S ≈ 1.85 half-size + Sep skip.
Artifacts: ``live/demo/us30_monday_or_m3_s3_r2_half_paper/``.
...
INSTRUMENT = "US30"
STRATEGY_ID = "us30_monday_or_m3_s3_r2_half_paper"
RUN_DIRNAME = "us30_monday_or_m3_s3_r2_half_paper"
PHASE2_TAG = PAIR_PHASE2_DEFAULT["US30"]  # M3_S3_R2
TICK = 0.1
CLI_COMMAND = "demo-us30-monday-or-paper"
...
def run_stream_loop(
    *,
    ...
    append_progress(
        output_root,
        "STARTED US30 Monday OR paper tag=%s strategy=%s account=%s state=%s pid=%s"
