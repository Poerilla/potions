"""US30 v2b OCO ungated paper demo: OANDA US30_USD prices in, PaperBroker only (YM proxy).

Artifacts live under ``live/demo/us30_v2b_ungated_paper/`` (parallel to the
...
INSTRUMENT = "US30"
STRATEGY_ID = "us30_v2b_ungated_demo"
STRATEGY_TYPE = "v2b_scaleout"
ENTRY_QTY = 3
TP1_QTY = 1
TP2_QTY = 1
TICK = 0.1  # OANDA US30_USD displayPrecision=1 (YM proxy)
...
def default_output_root() -> Path:
    return demo_run_root("us30_v2b_ungated_paper")
