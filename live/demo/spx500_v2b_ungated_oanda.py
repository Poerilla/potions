"""SPX500 v2b ungated OANDA practice demo — real practice orders."""
...
SPEC = OandaDemoSpec(
    instrument="SPX500",
    strategy_id="spx500_v2b_ungated_oanda",
    run_dirname="spx500_v2b_ungated_oanda",
    tick=0.1,
)
CLI_COMMAND = "demo-spx500-v2b-oanda"
