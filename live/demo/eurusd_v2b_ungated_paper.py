"""EURUSD v2b OCO ungated paper demo: OANDA prices in, PaperBroker only.

Artifacts live under ``live/demo/eurusd_v2b_ungated_paper/`` (parallel to
``live/state/``). No orders are routed to OANDA.
"""
...
INSTRUMENT = "EURUSD"
STRATEGY_ID = "eurusd_v2b_ungated_demo"
...
def default_output_root() -> Path:
    return demo_run_root("eurusd_v2b_ungated_paper")
