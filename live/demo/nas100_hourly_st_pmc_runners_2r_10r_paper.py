"""NAS100 hourly ST+PMC sl50_tp150_runners_2r_10r — paper demo (OANDA prices, PaperBroker fills).

1m-fill lot-correct N/S ≈ 11.1. Artifacts: ``live/demo/nas100_hourly_st_pmc_sl50_tp150_runners_2r_10r_paper/``.
...
STRATEGY_ID = "nas100_hourly_st_pmc_sl50_tp150_runners_2r_10r_paper"
RUN_DIRNAME = "nas100_hourly_st_pmc_sl50_tp150_runners_2r_10r_paper"
CLI_COMMAND = "demo-nas100-hourly-st-pmc-2r10r-paper"
...
def bootstrap_store(output_root: Path) -> FlatFileStore:
    ...
    n = seed_hourly_history(store, source="nas100_1h_csv_seed_paper")
    if n:
...
def run_stream_loop(
    *,
    ...
    append_progress(
        output_root,
        "STARTED NAS100 ST+PMC paper variant=%s strategy=%s account=%s state=%s pid=%s"
