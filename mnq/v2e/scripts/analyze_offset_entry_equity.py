#!/usr/bin/env python3
"""Equity path for ``simulate_london_offset_entry`` (offset limits + 30pt SL); same session grid as child equity script."""
...
from sim_london_offset_entry import simulate_london_offset_entry  # noqa: E402
...
def main() -> int:
    ...
    for d in sorted(days):
        ...
        sim = simulate_london_offset_entry(
            df1,
            lh,
            ll,
            None,
    ...
    print(
        f'London **offset entry** sim  ·  L±{args.offset_pts:g} pt limits  ·  SL={args.sl_pts:g} pt  ·  '
        f'ORB pierce: {orb_on}'
    )
